...
const PrintLabelPage = () => {
  ...
  // Use a reliable QR code API to generate the QR code image
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://agrosave.com/track/${tracking}`;
      ...
      <div className="px-4 py-6 flex flex-col items-center">
        ...
        >
          ...
          <div className="bg-primary px-5 py-3 flex items-center justify-between">
            ...
            <span className="text-primary-foreground/80 text-[10px] font-medium uppercase tracking-widest">
              Shipping Label
            </span>
          </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start gap-1.5 text-xs text-muted-foreground">
                    ...
                    <span className="leading-tight">
                      {currentUser.address || "123 Farm Road, KL"}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="px-5 py-3 border-t border-border bg-muted/20">
            ...
            <p className="text-center text-[9px] text-muted-foreground tracking-widest font-mono">
              {tracking}
            </p>
          </div>
          ...
          <div className="bg-primary/5 px-5 py-2.5 border-t border-border">
            <p className="text-[9px] text-muted-foreground text-center">
              AgroSave Food Distribution Network · agrosave.com · Handle with
              care — Fresh Produce
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm mt-4 bg-card rounded-xl p-4 border border-border no-print">
          ...
          <p className="text-xs text-muted-foreground">
            The QR code on this label links to the live tracking page for your
            shipment. Scan it with any QR reader to view real-time delivery
            status.
          </p>
          <div className="mt-2 bg-muted/50 rounded-lg px-3 py-2">
            <p className="text-[10px] text-muted-foreground font-mono break-all">
              https://agrosave.com/track/{tracking}
            </p>
          </div>
        </div>
      </div>
